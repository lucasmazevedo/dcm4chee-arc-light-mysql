...
RUN cd $JBOSS_HOME \
    ...
    && curl -fO https://downloads.mariadb.com/Connectors/java/connector-java-2.5.3/mariadb-java-client-2.5.3.jar \
    && cd /docker-entrypoint.d/deployments \
    && curl -fO http://cajuinaweb.com.br/dcm4chee-arc-ear-5.19.1-mysql-secure-ui.ear
